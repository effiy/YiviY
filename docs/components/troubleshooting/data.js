...
window.TROUBLESHOOTING_CONFIG = {
    ...
    helpLinks: [
        { icon: '🆓', label: 'Free AI QA Agent →', href: 'https://share.fastgpt.in/chat/share?shareId=066w11n3r9aq6879r4z0v9rh' },
        { icon: '🐛', label: 'GitHub Issues →',    href: 'https://github.com/Huanshere/VideoLingo/issues' },
        { icon: '📧', label: 'Email: team@videolingo.io', href: 'mailto:team@videolingo.io' }
    ]
};
