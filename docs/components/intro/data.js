...
window.INTRO_CONFIG = {
    ...
    en: {
        ...
        overview: {
            ...
            features: [
                /* ── 外部工具 · 自定义链接指向工具自身仓库 ── */
                { name: '🎥 yt-dlp', nameHref: 'views/yt-dlp/index.html', nameTarget: '', desc: 'YouTube video download via yt-dlp · <strong>1,200+ sites</strong> · format selection · subtitle extraction',
    ...
    'zh-CN': {
        ...
        overview: {
            ...
            features: [
                /* ── 外部工具 · 自定义链接指向工具自身仓库 ── */
                { name: '🎥 yt-dlp', nameHref: 'views/yt-dlp/index.html', nameTarget: '', desc: '使用 yt-dlp 下载 YouTube 视频 · <strong>1,200+ 站点</strong> · 格式选择 · 字幕提取',
